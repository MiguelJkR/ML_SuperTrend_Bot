"""
ML SuperTrend v51 - Entrenador para Google Colab (GPU Gratuita)
================================================================
Script diseñado para ejecutar en Google Colab con GPU T4/A100 gratuita.
Entrena el modelo LSTM con más datos y epochs de los que tu PC permite.

INSTRUCCIONES GOOGLE COLAB:
  1. Ve a https://colab.research.google.com
  2. Crea un nuevo notebook
  3. Menu: Runtime → Change runtime type → GPU (T4)
  4. Sube este archivo y tu data de candles
  5. Ejecuta celda por celda

ALTERNATIVA DIRECTA:
  Copia y pega el contenido de cada "celda" como celdas de código en Colab.

El modelo entrenado se descarga como .pt y se carga en tu bot local.
...
def generate_colab_notebook():
    """
    Generar un archivo .py con todas las celdas de Colab.
    Para usar: copia cada CELDA como una celda separada en Colab.
    """
    import os
    print("=" * 60)
    print("ML SuperTrend v51 - Google Colab Trainer")
    print("=" * 60)
    print()
    print("Este script contiene 6 celdas para Google Colab:")
    print()
    print("  CELDA 1: Setup (instalar dependencias)")
    print("  CELDA 2: Definir modelo (LSTM + Multi-Head Attention)")
    print("  CELDA 3: Descargar datos (yfinance, 2 anios, 6 pares)")
    print("  CELDA 4: Entrenar (50 epochs, GPU, mixed precision)")
    print("  CELDA 5: Evaluar (graficos de loss y accuracy)")
    print("  CELDA 6: Exportar (.pt para cargar en tu bot)")
    print()
    print("INSTRUCCIONES:")
    print("  1. Ve a https://colab.research.google.com")
    print("  2. Nuevo notebook → Runtime → GPU (T4)")
    print("  3. Copia cada CELDA como celda de codigo")
    print("  4. Ejecuta en orden")
    print("  5. Descarga el .pt y copialo a tu bot")
    print()

    # Guardar notebook como script
    notebook_path = os.path.join(
        os.path.dirname(os.path.abspath(__file__)),
        "colab_notebook_cells.py"
    )
    with open(notebook_path, 'w', encoding='utf-8') as f:
        f.write("# ML SuperTrend v51 - Google Colab Training Notebook\n")
        f.write("# Copia cada seccion como una celda separada en Colab\n")
        f.write("# Runtime → Change runtime type → GPU (T4)\n\n")

        cells = [
            ("CELDA 1: Setup", CELDA_1_SETUP),
            ("CELDA 2: Modelo", CELDA_2_MODELO),
            ("CELDA 3: Datos", CELDA_3_DATOS),
            ("CELDA 4: Entrenar", CELDA_4_ENTRENAR),
            ("CELDA 5: Evaluar", CELDA_5_EVALUAR),
            ("CELDA 6: Exportar", CELDA_6_EXPORTAR),
        ]
